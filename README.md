...
# Introduction:
This is an Advanced & Feature Rich Server Software to hopefully Replace [Tesseract](https://www.github.com/TesseractTeam).  
...
- [X] **EnderPearls**
- [X] **SplashPotions**
- [X] **XBoxLive Authentication** (Will not work without [Open-SSL](https://www.github.com/LeverylTeam/PHP7-Binaries) Extension)
- [X] **Cauldrons**
...
- Some Implementations are ported from [Tesseract](https://www.github.com/TesseractTeam), [GenisysPro](https://www.github.com/GenisysPro) and [Genisys](https://www.github.com/ITXTech/Genisys)
