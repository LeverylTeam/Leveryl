...
class Binary
{
     ...
     * @return int
     */
    public static function readVarLong_64(string $buffer, &$offset): int
    {
     ...
     * @return int
     */
    public static function readUnsignedVarLong_64(string $buffer, &$offset): int
    {
        $value = 0;
        for ($i = 0; $i <= 63; $i += 7) {
            $b = ord($buffer{$offset++});
     ...
     * @return string
     */
    public static function writeUnsignedVarLong_32($value): string
    {
        $buf = "";
