...
class Weather {
    ...
    public function calcWeather($currentTick) {
        if ($this->canCalculate()) {
            ...
            if ($this->duration <= 0) {
                $duration = mt_rand(
                    min($this->level->getServer()->getLeverylConfigValue("weatherRandomDurationMin", 6000), $this->level->getServer()->getLeverylConfigValue("weatherRandomDurationMax", 12000)),
                    max($this->level->getServer()->getLeverylConfigValue("weatherRandomDurationMin", 6000), $this->level->getServer()->getLeverylConfigValue("weatherRandomDurationMax", 12000))
                );
