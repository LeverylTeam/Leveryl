...
class WeatherCommand extends VanillaCommand {
    ...
    public function execute(CommandSender $sender, $currentAlias, array $args) {
        ...
        if ($sender instanceof Player) {
            ...
            if (!isset($args[1])) $duration = mt_rand(min($sender->getServer()->getLeverylConfigValue("weatherRandomDurationMin", 6000), $sender->getServer()->getLeverylConfigValue("weatherRandomDurationMax", 12000)), max($sender->getServer()->getLeverylConfigValue("weatherRandomDurationMin", 6000), $sender->getServer()->getLeverylConfigValue("weatherRandomDurationMax", 12000)));
