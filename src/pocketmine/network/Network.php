...
// 1.2		$this->registerPacket(ProtocolInfo::SPAWN_EXPERIENCE_ORB_PACKET, SpawnExperienceOrbPacket::class);
...
// 1.2		$this->registerPacket(ProtocolInfo::UPDATE_TRADE_PACKET, UpdateTradePacket::class);
//		$this->registerPacket(ProtocolInfo::USE_ITEM_PACKET, UseItemPacket::class);
// 1.2		$this->registerPacket(ProtocolInfo::BLOCK_PICK_REQUEST_PACKET, BlockPickRequestPacket::class);
// 1.2		$this->registerPacket(ProtocolInfo::COMMAND_BLOCK_UPDATE_PACKET, CommandBlockUpdatePacket::class);
...
// 1.2		$this->registerPacket(ProtocolInfo::MOB_EFFECT_PACKET, MobEffectPacket::class);
...
// 1.2		$this->registerPacket(ProtocolInfo::INVENTORY_CONTENT_PACKET, InventoryContentPacket::class);
// 1.2		$this->registerPacket(ProtocolInfo::INVENTORY_SLOT_PACKET, InventorySlotPacket::class);
// 1.2		$this->registerPacket(ProtocolInfo::GUI_DATA_PICK_ITEM_PACKET, GuiDataPickItemPacket::class);
...
// 1.2		$this->registerPacket(ProtocolInfo::COMMAND_OUTPUT_PACKET, CommandOutputPacket::class);
